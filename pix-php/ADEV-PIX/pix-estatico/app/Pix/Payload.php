...
class Payload{
    ...
    */
    ...
    /**
     * Método responsável por retornar os valores completos da 
     * informação da conta
     * @return string
    */
    ...
    /**
     * Método responsável por retornar os valores completos do campo adicional
     * do pix (TXID)
     * @return string
    */

    public function getAdicionalDataFieldTemplate(){
        //TXID
    ...
    */
    ...
    public function getPayload(){
        ...
        $payload = $this->getValue(self::ID_PAYLOAD_FORMAT_INDICATOR, '01').
                        ...
                        $this->getAdicionalDataFieldTemplate();
         ...
         * Esse método utiza operadores bit a bit/ bitwise do PHP. 
         * Pesquisar sobre detecção de erros em comunicação de dados CRC16
