...
class Artigo
{
    ...
    {
       $insereArtigo = $this->mysql->prepare("INSERT INTO
        artigos (titulo, conteudo) VALUES(?,?) ");
    ...
    {
        $selecionaArtigo = $this->mysql->prepare("SELECT id, conteudo,
        titulo FROM artigos WHERE id = ?");
